...
const required=["index.html","assets/styles.css","assets/runtime-config.js","assets/course-data.js","assets/app.js","manifest.webmanifest","service-worker.js","404.html",".nojekyll"];
...
for(const file of ["./assets/styles.css","./assets/runtime-config.js","./assets/course-data.js","./assets/app.js","./manifest.webmanifest"]){if(!html.includes(file))throw new Error(`入口未引用: ${file}`)}
...
console.log(`验证通过：${required.length}个部署文件、${ids.length}个页面ID、ABB六轴轨迹约束。`);
